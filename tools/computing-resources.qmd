...
We recommend requesting a Windows or Max device, as this allows you to use desktop versions of the Office 365 apps.
...
You can [apply for access to the University HPC](https://www.acrc.bris.ac.uk/login-area/apply.cgi).
